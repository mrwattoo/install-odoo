...
echo -e "\n Installaion of ODOO17 Process Start\n"
OE_USER="odoo17"
echo -e "\n---- Update Server ----\n"
...
sudo su ${OE_USER} -c "git clone https://www.github.com/odoo/odoo --depth 1 --branch 17.0 /opt/${OE_USER}/odoo"
...
sudo su root -c "printf 'xmlrpc_port = 1700\n' >> /etc/${OE_USER}.conf"
